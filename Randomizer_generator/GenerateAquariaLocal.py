...
def generate_aquaria_arguments(options: Dict, arguments: Namespace) -> None:
    ...
    if "excludeHardItem" in options and options["excludeHardItem"]:
        arguments.exclude_hard_or_hidden_locations = {1: ExcludeHardOrHiddenLocation(1)}
    else:
        arguments.exclude_hard_or_hidden_locations = {1: ExcludeHardOrHiddenLocation(0)}
